...
function createData(id: number, categoryName: string, description: string, name: string, price: number, priority: number): Data {
   return {
      categoryName,
      description,
      id,
...
function descendingComparator<T extends Record<keyof T, string | number>>(a: T, b: T, orderBy: keyof T) {
...
export default function App() {
   ...
   const url: string = 'https://roman.itstep.click/api/Products/list'
   ...
   const rows: Data[] = data.map((item) => createData(item.id, item.categoryName, item.description, item.name, item.price, item.priority))
